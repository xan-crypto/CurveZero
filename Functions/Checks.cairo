...
from Functions.Math64x61 import Math64x61_div, Math64x61_mul, Math64x61_convert_from, Math64x61_zero, Math64x61_convert_to, Math64x61_ts, Math64x61_add, Math64x61_fromUint256_felt, Math64x61_fromFelt   
...
func check_min_pp{syscall_ptr : felt*, pedersen_ptr : HashBuiltin*, range_check_ptr}(settings_addy : felt, num_pp : felt):
    alloc_locals
    let (convert_num_pp) = Math64x61_fromFelt(num_pp)
